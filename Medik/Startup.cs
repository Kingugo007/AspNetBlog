...
namespace Medik
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IAuthServices, RegisterServices>();   
            services.AddSingleton<IJsonOperations, JsonOperations>();
            services.AddSingleton<IUploadFiles, UploadFiles>(); 
